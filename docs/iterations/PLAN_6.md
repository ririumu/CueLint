...
- [ ] self-merge `codex/v011-scope-language` to `main`
- [ ] clear it `[x]`
- [ ] cut branch `codex/v011-output-contract`
- [ ] add metadata interpretation-contract fields and tests
- [ ] commit output-contract changes
...
- [ ] README describes CueLint as a surface cue evidence linter, not a quality evaluator or over-refusal classifier.
- [ ] JSON metadata records the interpretation contract without changing the CLI interface.
